            ...
            <div className="headerWrapper relative">
                <div className="container">
                    <div className="navigation flex items-center justify-between py-[20px]">
                        ...
                        <div className={opennav ? 'mob_menus md:hidden rounded-md w-full bg-white min-h-[97vh] z-[1] left-[50%] translate-x-[-50%] top-3 fixed px-5 z-1 w-[95%] pt-[20px] ease-linear duration-500 ' : 'mob_menus md:hidden w-full bg-white min-h-[97vh] z-[1] left-[-100%] top-3 fixed px-5 z-1 w-11/12 pt-[20px] ease-linear duration-500 rounded-md'}>
