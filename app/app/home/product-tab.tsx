        ...
        <>
                ...
                <div className="tab_section text-center pt-[10px]">
                    <div className="tab_btn">
                        <button data-attr="1" onClick={() => clickTab(1)} className={activetab == 1 ? 'text-[16px] md:text-[20px] font-bold border-b-4 border-solid border-primary text-[#251048] transition ease-in-out duration-300' : 'transition ease-in-out duration-300 text-[16px] md:text-[20px] text-black'}>Newly Arrived</button>
                        <button data-attr="2" onClick={() => clickTab(2)} className={activetab == 2 ? 'text-[16px] md:text-[19px] md:text-[20px] font-bold border-b-4 border-solid border-primary text-[#251048] ml-[20px] transition ease-in-out duration-300' : 'text-[16px] md:text-[20px] ml-[20px] text-black transition ease-in-out duration-300'}>Featured Products</button>
                    </div>
                    <div className={activetab == 1 ? 'block container' : 'hidden container'} data-attr="1">
                        <div className="prod-with-detail prod-detila flex md:flex-nowrap md:flex-wrap md:justify-center gap-8 mt-8 overflow-auto md:overflow-none md:pb-0 pb-2">
                            {loading ? <Skeleton /> : <>
                                    ...
                                    data?.map((item:any,index:any) => {
                                        return (
                                            ...
                                            {/* <div className="text-center product-main w-full md:max-w-[300px]  w-full w-72 bg-white shadow-md rounded-xl duration-500 border border-[#0005] overflow-hidden" key={index}>
                                                ...
                                                <div className="text-center product-main w-full md:max-w-[300px]  w-full w-72 rounded-xl duration-500 border border-[#0005] overflow-hidden bg-primary p-[15px] shrink-[.1]" key={index}>
                                                    <Link href={`/products/${item.slug}`} className="inline-block w-full">
                                                        <div className="prod-image relative md:w-[250px] w-full h-[100%] md:h-[250px] h-[200px] mx-auto md:pt-[105%] pt-0 bg-white border-1-[#25104830] rounded-[15px] overflow-hidden mb-[15px]">
                     ...
                     {loading ? <Skeleton /> : <>

                                {
                                    featured.slice(0,4).map((data: any) => {
                                        return (
                                            <>
                                                <div className="text-center product-main w-full md:max-w-[300px]  w-full w-72 rounded-xl duration-500 border border-[#0005] overflow-hidden bg-primary p-[15px] shrink-[.1]" key={data.id+1}>
