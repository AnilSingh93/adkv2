...
export default function Contact() {
  ...
  const validate = () => {
    ...
    // Name Validation
    if (!formData.first_name.trim()) errors.first_name = "Name is required";
    return errors;
       ...
       <>
        <div className="container md:pt-10 pt-2">
            <div className="md:w-[700px] md:block md:mx-auto w-full">
                ...
                <p className="md:text-[16px] color-[#454545] md:leading-6 leading-4 md:mb-5 mb-2">For all your needs, ADK Instrument’s team of industry experts is there to help you out 24x7. You can get in touch with us via our round-the-clock customer support team. Alternatively, you can e-mail us at <a href="mailto:enquiry@adkinstruments.in">enquiry@adkinstruments.in</a></p>
                    ...
                    <form className="md:flex flex-wrap justify-between md-mt-0 mt-8" onSubmit={handleSubmit}>
                        ...
                        className="text-[12px] placeholder:text-[12px] md:tex-[16px] md:placeholder:text-[14px] mb-4 border-2 border w-full md:w-[49%] border-grey p-2" type="text"
