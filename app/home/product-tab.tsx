                ...
                <div className="tab_section text-center pt-[10px]">
                    ...
                    <div className={activetab == 1 ? 'block container' : 'hidden container'} data-attr="1">
                        <div className="prod-with-detail prod-detila flex md:flex-nowrap flex-wrap justify-center gap-8 mt-8">
                            {loading ? <Skeleton /> : <>

                                {
                                    data?.map((item:any,index:any) => {
                                        return (
                                             <>                                            
                                            <div className="text-center product-main w-full md:max-w-[300px]  w-full w-72 bg-white shadow-md rounded-xl duration-500 border border-[#0005]" key={index}>
                            ...
                            <Link href="#" className=" mt-[35px] md:py-[11px] md:px-[28px] text-center inline-block relative justify-center border border-primary border-2 rounded-[50px] mx-auto bg-#fff text-primary hover:bg-secondary hover:text-[#fff] uppercase hover:border-secondary hover:bg-secondary md:text-[15px] font-[600] md:tracking-[1px] tracking-[.5px] text-[12px] py-[8px] px-[20px]">View Details</Link>
                     ...
                     {loading ? <Skeleton /> : <>

                                {
                                    featured.slice(0,4).map((data: any) => {
                                        return (
                                            <>
                                                <div className="text-center product-main w-full md:max-w-[300px]  w-full w-72 bg-white shadow-md rounded-xl duration-500 border border-[#0005]" key={data.id+1}>
