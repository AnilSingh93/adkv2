...
const Products = ({ params }: any) => {
    ...
    const settings = {
        ...
        appendDots: dots => (
          <div className='aa'>
            <ul className='prod_cust_list'> {dots} </ul>
          </div>
        ),
        customPaging: i => (
          <div className='w-[50px] h-[50px]'>
                {
                    <Image fill loading='lazy' src={allData.media[i]} alt="product image" style={{ objectFit: "contain" }} />
                }
            ...
            <div className="flex flex-wrap md:flex-nowrap justify-between md:pt-8 pt-5">
                <div className="md:w-1/2 w-full">
                    <div className="">
                     ...
                     <div className="slider-container">
        <div className='main_prod_slider'>
      <Slider {...settings}>
          {
                                    allData.media?.map((images, id) => <div className="bg-[#d1caca1a] relative thumbnail prod_slider md:w-[600px] md:h-[550px] h-[250px]"><Image fill loading='lazy' src={images} alt="product image" style={{ objectFit: "contain"}} className="mix-blend-multiply" key={id + 5} /></div>)
                                }
      </Slider>
        </div>        
    </div>
                ...
                <div className="md:w-1/2 w-full md:pl-5">
                    ...
                    <h1 className='mt-8 md:mt-0 md:mb-5 mb-3 font-bold text-[22px] leading-7'>{allData.name}</h1>
                    ...
                    <div className="border-t border-[#DFDFDF] pt-5">
                        ...
                        <div className="flex items-center gap-3 pt-1">
                            <img src="/img/truck.png" className='w-[18px]' /> Standard 9-15 Days Delivery | Once received to our Hub
                        </div>
                    </div>
