                    ...
                    <div className="md:w-[40%] md:block md:mx-auto w-full  border">
                        ...
                        <div className="contact_etails md:pt-8 pt-2 p-4">
                            <form className="md:flex flex-wrap justify-between md-mt-0 mt-8">
                                ...
                                <textarea className="text-[12px] placeholder:text-[12px] md:tex-[16px] md:placeholder:text-[14px] border-2 border w-full border-grey p-2 md:h-[150px] h-[100px] resize-none" placeholder="Comments *"></textarea>
